        ...
        <div class="departure-planner-pro">
            <div class="dpp-header">
                ...
                <div>
                    ...
                    <p>Naplánuj si cestu s vlastními kroky (zastávky, příprava, rezervy)</p>
                </div>
            </div>

            <!-- CÍLOVÝ ČAS -->
            <div class="dpp-section">
                <label class="dpp-label">🎯 Cílový čas (kdy musím být na místě)</label>
            ...
            <div class="dpp-section">
                <div class="dpp-steps-header">
                    <label class="dpp-label">📋 Seznam kroků (od cíle zpětně)</label>
            ...
            <div class="dpp-buttons">
                ...
                <button id="dpp-clear" class="dpp-btn dpp-btn-secondary">🗑️ Vyčistit vše</button>
            </div>
            ...
            <!-- Tip -->
            <div class="dpp-tip">
                💡 <strong>Tip:</strong> Můžeš přidat libovolný počet kroků (cesta, příprava, zastávka na kafe, tankování...). Každý krok má svou rezervu.
            </div>
        </div>
    `;
